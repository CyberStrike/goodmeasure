...
class CohortsControllerTest < ActionController::TestCase
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post :create, cohort: { description: @cohort.description, name: @cohort.name, school_id: @cohort.school_id }
    end
  ...
  test "should update cohort" do
    patch :update, id: @cohort, cohort: { description: @cohort.description, name: @cohort.name, school_id: @cohort.school_id }
    assert_redirected_to cohort_path(assigns(:cohort))
  end
